...
# python main.py sequence src/datasets/unknown_spectra.mgf --model outputs/epoch=4-step=40000.ckpt --config src/config.yaml --output predictions.mztab --verbosity info